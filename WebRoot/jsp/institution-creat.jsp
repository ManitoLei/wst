	...
	<div class="content-pages-wrap">
		...
		<!-- <form>
			...
			<form id="institutionCreat" name="institutionCreat"
				action="<%=basePath%>orgservlet?type=create" method="post">
				
			<tr>
				<td align="right"><span class="required">*</span>机构编码：</td>
				<td align="left">
					<!-- 机构编码:行政区划9位+3  位流水，由系统自动根据行政区划生成，不可编辑 -->
					<input name="orgNo" type="text" class="inputTextMiddle" id="orgNo" value="行政区划9位+流水3位自动生成" disabled/></td>
				<td align="right"><span class="required">*</span>机构代码：</td>
				<td align="left" colspan="3">
					<input name="orgCode" type="text" class="inputTextMiddle" id="orgCode" required="required"/>(<span
					class="required">代码格式:XXXXXXXX-X</span>)</td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span>机构名称：</td>
				<td align="left">
					<input name="orgName" type="text" class="inputTextMiddle" id="orgName" /></td>
			...
			<tr>
				...
				<td colspan="3" align="left"><input name="linkAdd"
					type="text" class="inputTextLong" id="linkAdd" /></td>
				<td align="right">邮编：</td>
				<td align="left"><input name="ZIPCODE" type="text"
					class="inputTextNormal" id="ZIPCODE" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span>行政区划：</td>
				<td align="left">
					<input name="areaCode" type="text" class="inputTextNormal" id="areaCode" />(<span
					class="required">9位</span>)</td>
				<td align="right">挂牌日期：</td>
				<td align="left"><input name="listingDate" type="text"
					class="inputTextNormal" id="listingDate" /></td>
				<td align="right">独立运行日期：</td>
				<td align="left"><input name="standaloneDate" type="text"
					class="inputTextNormal" id="standaloneDate" /></td>
			</tr>
			<tr>
				...
				<td align="left">
					<input name="onworkerNum" type="text"
					class="inputTextNormal" id="onworkerNum" /></td>
				<td align="right">卫生监督员数：</td>
				<td align="left"><input name="supervisorNum" type="text"
					class="inputTextNormal" id="supervisorNum" /></td>
			</tr>
			<tr>
				...
				<td align="left">
				<input name="zbbdocDate" type="text" class="inputTextNormal" id="zbbdocDate" /></td>
			</tr>
			<tr>
				...
				<td align="left">
					<input name="retireNum" type="text" class="inputTextNormal" id="retireNum" /></td>
				<td align="right"><span class="required">*</span>编制人数 ：</td>
				<td align="left">
					<input name="zbbNum" type="text" class="inputTextNormal" id="zbbNum" /></td>
			</tr>
			<tr>
				...
				<td align="left"><input name="officeBuildingarea" type="text"
					class="inputTextNormal" id="officeBuildingarea" /></td>
				<td align="right"><span class="required">*</span>办公用房建筑面积（平方米）
					：</td>
				<td align="left"><input name="officeBuildarea" type="text"
					class="inputTextNormal" id="officeBuildarea" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span>职能科室数 ：</td>
				<td align="left"><input name="businessDivCount" type="text"
					class="inputTextNormal" id="businessDivCount" /></td>
				<td align="right"><span class="required">*</span>派出机构数 ：</td>
				<td align="left"><input name="orgCount" type="text"
					class="inputTextNormal" id="orgCount" /></td>
				<td align="right"><span class="required">*</span>业务科室数 ：</td>
				<td align="left"><input name="funDivCount" type="text"
					class="inputTextNormal" id="funDivCount" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span>检测仪器设备数 ：</td>
				<td align="left" colspan="5">
					<input name="equ3Count" colspan="2" type="text" id="equ3Count" size="4" />（价格大于一千,小于一万）<br />
					<input name="equ2Count" colspan="2" type="text" id="equ2Count" size="4" />（价格大于一万、小于十万）<br /> 
					<input name="equ1Count" type="text" id="equ1Count" size="4" />（价格大于十万）</td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span> 汽车数（不含快速检测车）
					：</td>
				<td align="left"><input name="busCount" type="text" class="inputTextNormal" id="busCount" /></td>
				<td align="right"><span class="required">*</span> 快速检测车数 ：</td>
				<td align="left"><input name="rapidtestvehicleCount" type="text" class="inputTextNormal" id="rapidtestvehicleCount" /></td>
				<td align="right"><span class="required">*</span> 摩托车数 ：</td>
				<td align="left"><input name="motorCount" type="text" class="inputTextNormal" id="motorCount" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span> 照相机数：</td>
				<td align="left"><input name="cameraCount" type="text" class="inputTextNormal" id="cameraCount" /></td>
				<td align="right"><span class="required">*</span> 摄像机数 ：</td>
				<td align="left"><input name="videoCount" type="text"
					class="inputTextNormal" id="videoCount" /></td>
				<td align="right"><span class="required">*</span> 复印机数：</td>
				<td align="left"><input name="copycatNum" type="text"
					class="inputTextNormal" id="copycatNum" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span> 台式电脑数 ：</td>
				<td align="left">
					<input name="computerNum" type="text" class="inputTextNormal" id="computerNum" /></td>
				<td align="right"><span class="required">*</span>笔记本电脑数 ：</td>
				<td align="left">
					<input name="notepadNum" type="text" class="inputTextNormal" id="notepadNum" /></td>
				<td align="right"><span class="required">*</span> 服务器数 ：</td>
				<td align="left">
					<input name="serverCount" type="text" class="inputTextNormal" id="serverCount" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span>交换机数 ：</td>
				<td align="left">
					<input name="pbxCount" type="text" class="inputTextNormal" id="pbxCount" /></td>
				<td align="right"><span class="required">*</span>传真机数 ：</td>
				<td align="left">
					<input name="faxCount" type="text" class="inputTextNormal" id="faxCount" /></td>
				<td align="right"><span class="required">*</span>投影仪数 ：</td>
				<td align="left">
					<input name="ohpCount" type="text" class="inputTextNormal" id="ohpCount" /></td>
			</tr>
			<tr>
				<td align="right"><span class="required">*</span>录音笔数：</td>
				<td align="left">
					<input name="VRCOUNT" type="text" class="inputTextNormal" id="VRCOUNT" /></td>
				<td align="right"></td>
				<td align="left"></td>
				<td align="right"></td>
				<td align="left"></td>
		...
		<div class="commonToolBar">
			<a href="<%=basePath %>jsp/institution-appropriation-creat.jsp" title="机构创建"
		...
		<table border="0" cellspacing="1" cellpadding="0" class="commonTable">
			...
			<tr>
				...
				<td align="center"><a
					href="<%=basePath %>jsp/institution-appropriation-creat.jsp" class="btnIconEdit"
